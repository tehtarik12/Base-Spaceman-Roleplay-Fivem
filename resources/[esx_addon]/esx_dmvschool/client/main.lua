...
function StopTheoryTest(success)
	...
	if success then
		TriggerServerEvent('esx_dmvschool:addLicense', 'simt')
...
function OpenDMVSchoolMenu()
	...
	if not ownedLicenses['simt'] then
	...
	if ownedLicenses['simt'] then
		if not ownedLicenses['simb'] then
			table.insert(elements, {
		...
		if not ownedLicenses['sima'] then
			table.insert(elements, {
