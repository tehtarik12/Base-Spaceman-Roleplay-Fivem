Config = {
    ...
    PropsToRemove = {
        ...
        vector3(-3015.1042, 57.0086, 11.8382),
    },
    ...
    Text = {
        ...
        HINT_SETUP = 'Install game',
        HINT_TAKE_CUE = 'take the cue.',
        HINT_RETURN_CUE = 'put back the cue.',
        HINT_HINT_TAKE_CUE = 'To play billiards you need to get a cue.',
        HINT_PLAY = 'Play',

        BALL_IN_HAND_LEFT = 'Hand Left',
        BALL_IN_HAND_RIGHT = 'Hand Right',
        BALL_IN_HAND_UP = 'Hand Up',
        BALL_IN_HAND_DOWN = 'Hand Down',
