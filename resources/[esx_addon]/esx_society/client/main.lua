...
function OpenBossMenu(society, close, options)
	...
	ESX.TriggerServerCallback('esx_society:isBoss', function(isBoss)
		if isBoss then
			...
			table.insert(elements, {label = 'Mengecek Uang Perusahaan', value = 'check_societymoney'})
		...
		--[[if options.wash then
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'boss_actions_' .. society, {
				...
				elseif data.current.value == 'check_societymoney' then
					ESX.TriggerServerCallback('esx_society:getSocietyMoney', function(money)
						ESX.ShowNotification('Uang Perusahaan: $' .. money)
					end, society)
