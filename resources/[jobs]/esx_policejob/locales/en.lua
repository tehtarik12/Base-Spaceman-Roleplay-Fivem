Locales['en'] = {
  ...
  ['open_cloackroom'] = 'to change ~y~clothes~s~.',
  -- Armory
  ...
  ['armory'] = 'armory',
  ['open_armory'] = 'to access the ~y~Armory~s~.',
  ['armory_owned'] = 'owned',
  ['armory_free'] = 'free',
  ['armory_item'] = '$%s',
  ...
  ['garage_prompt'] = 'to access the ~y~Vehicle Actions~s~.',
  ...
  ['helicopter_prompt'] = 'to access the ~y~Helicopter Actions~s~.',
  ['shop_item'] = '$%s',
  ...
  ['impound_prompt'] = 'to cancel the ~y~impound~s~',
  ...
  ['owner'] = 'owner: %s',
  -- Boss Menu
  ['open_bossmenu'] = 'to open the menu',
  ...
  -- Misc
  ['remove_prop'] = 'to delete the object',
  ...
  --- JAIL / comserv
  ['judge']              	= 'JUDGE',
	['escape_attempt']     	= 'Kamu tidak bisa lari dari hukuman! atau hukuman mu akan bertambah.',
	['remaining_msg']      	= 'Kamu memiliki ~b~%s~s~ lagi untuk menyelesaikan hukuman.',
	['comserv_msg']       	= '%s telah dihukum %s bulan untuk menjalani hukuman sosial.',
	['comserv_finished']  	= '%s telah selesai menjalani hukuman!',
	['press_to_start']      = '[E] Clean',
	['system_msn']          = '^1SYSTEM',
