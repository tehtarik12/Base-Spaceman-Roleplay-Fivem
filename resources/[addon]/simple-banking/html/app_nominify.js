...
function AddAccount(account_name, account_type, bal, ply_Name, steamID)
{
    ...
    $("#Player_Accounts").append("<div id='"+temp_Name+"'\
        <div class='card bg-secondary'>\
            <div class='account'>\
                <h5 class='card-title comment'>" + account_name + (relang[account_type] === "personal" && " <i OnClick='EditAccount(\"" + transferAcc + "\")' class='justify-content-end right fa fa-cog account_settings'></i>" || "") + "</h5>\
