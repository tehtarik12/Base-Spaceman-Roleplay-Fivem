...
local dispatchCodes = {
	...
	blipSprite = 652, blipColour = 4, blipScale = 1.5 },

	officerdown = {displayCode = '10-99', description = _U('officerdown'), isImportant = 1, recipientList = {'police'},
	blipSprite = 653, blipColour = 4, blipScale = 1.5, infoM = 'fa-portrait'},

	persondown = {displayCode = '10-52', description = _U('persondown'), isImportant = 0, recipientList = {'police'},
	blipSprite = 153, blipColour = 4, blipScale = 1.5, infoM = 'fa-portrait'},

	autotheft = {displayCode = '10-16', description = _U('autotheft'), isImportant = 0, recipientList = {'police'},
	blipSprite = 651, blipColour = 4, blipScale = 1.5, infoM = 'fa-car', infoM2 = 'fa-palette' },

	speeding = {displayCode = '10-66', description = _U('speeding'), isImportant = 0, recipientList = {'police'},
	blipSprite = 650, blipColour = 4, blipScale = 1.5, infoM = 'fa-car', infoM2 = 'fa-palette' },

	shooting = { displayCode = '10-13', description = _U('shooting'), isImportant = 0, recipientList = {'police'},
	blipSprite = 648, blipColour = 4, blipScale = 1.5 },

	suspicious = { displayCode = '10-37', description = _U('suspicious'), isImportant = 0, recipientList = {'police'},
	blipSprite = 66, blipColour = 4, blipScale = 1.5, infoM = 'fa-info-circle' },

	robbery = { displayCode = '211', description = 'Robbery in progress', isImportant = 1, recipientList = {'police'},
	blipSprite = 134, blipColour = 4, blipScale = 1.5, infoM = 'fa-info-circle' },

	driveby = { displayCode = '10-13', description = _U('driveby'), isImportant = 0, recipientList = {'police'},
	blipSprite = 649, blipColour = 4, blipScale = 1.5, infoM = 'fa-car', infoM2 = 'fa-palette' },

	ruangankoma = { displayCode = '311', description = _U('ruangankoma'), isImportant = 0, recipientList = {'ambulance'},
	blipSprite = 280, blipColour = 2, blipScale = 1.5, infoM = 'fa-info-circle' },
}
...
AddEventHandler('wf-alerts:svNotify911', function(message, caller, coords, data)
	if message ~= nil then
		local pData = {}
		pData.displayCode = '911'
		pData.dispatchMessage = message
		if caller == _U('caller_unknown') then pData.dispatchMessage = _U('unknown_caller') end
