...
RegisterServerEvent('alvin_core:removeItem')
AddEventHandler('alvin_core:removeItem', function(src, item, count, metadata)
...
function addItem(source, item, count, metadata)
    ...
    if (Config.OxInventory) then
        ...
        if (canCarryItem) then
            ...
            TriggerClientEvent('alvin_core:Notify', source, 'error', 'You cannot carry this item')
            return false
        end
    else
...
AddEventHandler('alvin_core:addItem', function(item, count)
...
ESX.RegisterServerCallback('alvin_core:itemCountCb', function(source, cb, item, metadata)
    cb(itemCount(source, item, metadata))
end)
RegisterServerEvent('alvin_core:sv_itemCount')
AddEventHandler('alvin_core:sv_itemCount', function(source, item, metadata)
...
ESX.RegisterServerCallback('alvin_core:canHoldItem', function(source, cb, item, count)
    cb(canHoldItem(source, item, count))
end)
RegisterServerEvent('alvin_core:sv_canHoldItem')
AddEventHandler('alvin_core:sv_canHoldItem', function(source, item, count)
...
Instances
--]]---------------------------------------------------
RegisterServerEvent('alvin_core:AddToInstance')
AddEventHandler('alvin_core:AddToInstance', function(source, instanceId)
...
RegisterServerEvent('alvin_core:RemoveFromInstance')
AddEventHandler('alvin_core:RemoveFromInstance', function(source)
    if (GetPlayerRoutingBucket(source) ~= 0) then TriggerEvent('alvin_core:AddToInstance', source, 0) end
end)

--[[---------------------------------------------------
Misc
--]]---------------------------------------------------
ESX.RegisterServerCallback('alvin_core:illegalTaskBlacklist', function(source, cb)
    local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('alvin_core:jobCount', function(source, cb, job)
    cb(#ESX.GetExtendedPlayers('job', job))
end)

AddEventHandler('onResourceStart', function(resourceName)
    if ( string.find(resourceName, "bixbi_") ) then
        TriggerEvent('alvin_core:VersionCheck', resourceName, GetResourceMetadata(resourceName, 'version'), GetResourceMetadata(resourceName, 'versioncheck'))
    end
end)

AddEventHandler('alvin_core:VersionCheck', function(resourceName, currentVersion, url)
