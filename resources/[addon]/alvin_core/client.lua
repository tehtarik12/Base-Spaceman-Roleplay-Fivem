...
AddEventHandler('esx:playerLoaded', function(xPlayer)
	...
	--TriggerServerEvent('alvin_core:RemoveFromInstance', GetPlayerServerId(PlayerId()))
end)
...
RegisterNetEvent('alvin_core:Notify')
AddEventHandler('alvin_core:Notify', function(type, msg, duration)
...
RegisterNetEvent('alvin_core:Loading')
AddEventHandler('alvin_core:Loading', function(time, text)
	Loading(time, text)
end)
...
function itemCount(item, metadata)
	if (Config.OxInventory) then
		...
		ESX.TriggerServerCallback('alvin_core:itemCount', function(itemCount)
...
AddEventHandler('alvin_core:itemCount', function(item, metadata)
...
RegisterNetEvent('alvin_core:UseCommand')
AddEventHandler('alvin_core:UseCommand', function(cmd)
	ExecuteCommand(cmd)
end)

AddEventHandler('alvin_core:SetClothing', function(Type, Drawable, Texture)
