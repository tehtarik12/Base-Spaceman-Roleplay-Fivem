...
Config.Distance = 20.0 --The distance you want peds to spawn at
...
Config.PedList = {
	...
	----------------------------------------
	{
		...
		coords = vector3(147.0462, -2200.325, 4.679077), --EL RANCHO BLVD
		heading = 124.7244, 
		gender = "male", 
	    isRendered = false,
        ped = nil,
	...
	----------------------------------------
	{
		...
		coords = vector3(10.14066, -667.6351, 33.44177), --EL RANCHO BLVD
		heading = 8.503937, 
		gender = "male", 
	    isRendered = false,
        ped = nil,
		...
		----------------------------------------
		{
			...
			coords = vector3(2747.67, 3472.892, 55.66663), --EL RANCHO BLVD
			heading = 249.4488, 
			gender = "male", 
			isRendered = false,
			ped = nil,
		...
		{
			model = "a_m_y_mexthug_01",
			coords = vector3(460.1934, -739.6352, 27.34216), --EL RANCHO BLVD
			heading = 86.49, 
			gender = "male", 
			isRendered = false,
			ped = nil,
