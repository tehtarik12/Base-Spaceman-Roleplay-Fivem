...
Config.RadioListVisibilityCommand = "listradio"         -- Only works if Config.LetPlayersChangeVisibilityOfRadioList is set to true
...
Config.RadioListChangeNameCommand = "namaradio"       -- Only works if Config.LetPlayersSetTheirOwnNameInRadio is set to true
...
Config.ModifyRadioChannelNameCommand = "channelradio"    -- Changes the name of the radio channel **that the player is currently joined in** => this is a validation to prevent normal players from modifying the name of the restricted channels they don't have access to(such as police, & etc)
