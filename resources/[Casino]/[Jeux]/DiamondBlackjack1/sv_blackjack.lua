...
function giveChips(source,amount)
	...
	exports["fortislogs"]:addLog("Menang Judi Blackjack", fortisLogsTable)
    ...
    if gameId ~= nil and betAmount ~= nil and chairId ~= nil then 
        ...
        if not blackjackGameInProgress[gameId] then
            if tonumber(betAmount) then
                ...
                if betAmount > 1000000 then
                    TriggerClientEvent("blackjack:notify",source,"Maksimal Taruhan 50.000 chips")
                else 
                    if tryTakeChips(source,betAmount) then
                        ...
                        TriggerClientEvent("blackjack:notify",source,"Jumlah Taruhan: " .. tostring(betAmount) .. " chips")
                    end
                end
            end
        end
    else
        TriggerClientEvent("blackjack:notify",source,"Terjadi Kesalahan pada Taruhan")
    end
end)
